package com.ssafy.bium.common.exception;
...
public abstract class ExceptionMessage {
    ...
    public static final String NOT_MATCHING_PASSWORD = "비밀번호가 일치하지 않습니다.";
    public static final String NOT_EXIST_USER = "존재하지 않은 유저입니다.";
