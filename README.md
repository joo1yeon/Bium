...
> 📌 시연 영상 https://youtu.be/aLL42Mf6IVA
...
- [실행 화면](#-실행-화면)
  ...
  * [비밀번호 찾기](#비밀번호-찾기)
  * [비움방 검색](#비움방-검색)
  * [비움방 (실시간 라이브 스트리밍 비움)](#비움방-실시간-라이브-스트리밍-비움)
  * [방해버튼](#방해버튼)
  * [마이페이지 (비움 기록 확인)](#마이페이지-비움-기록-확인)
- [산출물](#-산출물)
    + [1. Figma](#1-figma)
    + [2. ERD](#2-erd)
    + [3. API 설계서](#3-api-설계서)
    ...
    + [6. Git Flow 브랜치 전략](#6-git-flow-브랜치-전략)
    + [7. Jira](#7-jira)
- [팀원 소개](#-팀원-소개)
...
- 2명 중 1명(47.9%)이 일상 속 스트레스 수준이 높은 편이라고 응답 <br>
  출처: [데일리팝(http://www.dailypop.kr)](https://www.dailypop.kr/news/articleView.html?idxno=53913)
- 아무것도 하지 않고 아무 생각도 하지 않는 순간이 오히려 사람들의 마음을 위로하며 새로운 정신 건강 관리법으로 각광벋움
- 2014년부터 멍 때리기 대회를 개최하며 멍 때리기가 시간 낭비라는 고정관념을 뛰어넘어 마음을 다스리는 방법으로 인정받고 있음
- 자신만의 시간을 보내고 싶어하는 사람들이 증가함
  - 검색 창에 '멍 때리기 좋은 곳'을 검색하면 한적한 관광지, 숙박업체가 추천된다.
  - SNS에서는 조용한 분위기가 일품인 멍 때리기 좋은 곳을 서로 공유하는 경우도 생겨나고 있다.
  - 대한민국 문화체육관광부와 소속기관이 운영하는 문화포털에서는 '서울에서 멍 때리기 좋은 곳'이라는 제목으로 도시 속 색다른 휴식 공간을 소개하며 사람들에게 신선한 정보를 제공한다.

### 목적

- 일상 생활 안에서 생각을 비우며 사람들의 정신 건강 관리를 돕기 위함
- 장소의 제약을 벗어나 영상을 통해 생각을 비울 수 있는 환경을 제공
- 리프레시를 통해 일상에 더 집중할 수 있는 기회 제공
